      ...
      .then((session) => {
        ...
        Promise.allSettled([
          ...
          if (cfgRes.status === "fulfilled" && (cfgRes.value as { ok?: boolean }).ok) {
            const c = (cfgRes.value as { config?: { master_payout_defaults: Record<string, string>; project_types: string[]; role_visibility: Record<string, { sections: string[] }>; roles?: string[] } }).config;
            ...
            <form
              ...
              onSubmit={async (e) => {
                ...
                if (!createPartnerForm.PartnerID.trim()) {
                  setCreatePartnerError("PartnerID 為必填");
                  return;
                }
            ...
            >
              ...
              <div className="flex-1 space-y-4 overflow-y-auto px-6 py-4 text-sm text-slate-100">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-slate-400">KOL開發者</label>
                    <input
                      type="text"
            ...
            <div className="flex max-h-[90vh] flex-col">
              ...
              <div className="flex-1 space-y-4 overflow-y-auto px-6 py-4 text-sm text-slate-100">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-slate-400">合作夥伴名稱 {canEditVisibility && "*"}</label>
                    {canEditVisibility ? (
                      <input
                        type="text"
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        setPartners((prev) => prev.map((p) => (p.PartnerID === data.partner!.PartnerID ? data.partner! : p)));
                        setShowEditPartner(false);
